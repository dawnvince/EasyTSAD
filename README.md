...
- [Features](#features)
    - [For Algorithm Researches](#for-algorithm-researches)
    - [For Evaluation Researches](#for-evaluation-researches)
    - [For Practitioners of Community or Enterprise](#for-practitioners-of-community-or-enterprise)
    - [Leaderboard Representation](#leaderboard-representation)
- [Built-in Methods](#built-in-methods)
- [Built-in Evaluation Protocols](#built-in-evaluation-protocols)
- [Get Started](#get-started)
  - [Installation](#installation)
    - [Prerequisites (environment manager like conda, pipenv or poetry is recommended)](#prerequisites-environment-manager-like-conda-pipenv-or-poetry-is-recommended)
    - [Using `pip` to install the suite from Pypi](#using-pip-to-install-the-suite-from-pypi)
    - [Additonal Dependencies](#additonal-dependencies)
  - [Prepare datasets](#prepare-datasets)
    - [Use default datasets](#use-default-datasets)
    - [Add your datasets](#add-your-datasets)
- [Usage](#usage)
  - [An example that implements a new method.](#an-example-that-implements-a-new-method)
    - [Prepare a global config toml file. If not provided, the default configuration will be applied:](#prepare-a-global-config-toml-file-if-not-provided-the-default-configuration-will-be-applied)
    - [Define the Controller](#define-the-controller)
    - [Load Dataset configurations](#load-dataset-configurations)
      - [Option 1: Load certain time series in one dataset:](#option-1-load-certain-time-series-in-one-dataset)
      - [Option 2: Load all time series in certain datasets:](#option-2-load-all-time-series-in-certain-datasets)
    - [Implement your algorithm (inherit from class BaseMethod):](#implement-your-algorithm-inherit-from-class-basemethod)
    - [Do Experiments for your algorithm](#do-experiments-for-your-algorithm)
      - [Option 1: Use config file for methods (Recommended)](#option-1-use-config-file-for-methods-recommended)
      - [Option 2: Specify the parameters in functions](#option-2-specify-the-parameters-in-functions)
    - [Perform evaluations (Based on the saved scores)](#perform-evaluations-based-on-the-saved-scores)
    - [Plot the anomaly scores for each time series](#plot-the-anomaly-scores-for-each-time-series)
- [Citation](#citation)
