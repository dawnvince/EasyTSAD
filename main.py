...
evaluations = [
    ...
    Evaluations.EventKthF1PA(3, mode="log", base=3),
    ...
    Evaluations.EventKthF1PA(3, mode="squeeze"),
    ...
    # Evaluations.EventRocPA(mode="log", base=3),
    Evaluations.EventPrcPA(mode="log", base=3),
    Evaluations.EventKthPrcPA(3, mode="log", base=3),
    Evaluations.EventKthPrcPA(10, mode="log", base=3),
    Evaluations.EventKthPrcPA(20, mode="log", base=3),
    Evaluations.EventKthPrcPA(50, mode="log", base=3),
    Evaluations.EventKthPrcPA(150, mode="log", base=3),
    # Evaluations.EventRocPA(mode="squeeze"),
    Evaluations.EventPrcPA(mode="squeeze"),
    Evaluations.EventKthPrcPA(3, mode="squeeze"),
    Evaluations.EventKthPrcPA(10, mode="squeeze"),
    Evaluations.EventKthPrcPA(20, mode="squeeze"),
    Evaluations.EventKthPrcPA(50, mode="squeeze"),
    Evaluations.EventKthPrcPA(150, mode="squeeze"),
